...
import { AbstractLifecycleService } from '@neditor/core/platform/lifecycle/common/lifecycleService';
...
import { addDisposableListener, EventType } from '@neditor/core/base/browser/dom';
import { IStorageService, WillSaveStateReason } from '@neditor/core/platform/storage/common/storage';
import { CancellationToken } from '@neditor/core/base/common/cancellation';
...
export class BrowserLifecycleService extends AbstractLifecycleService {
  ...
  private onUnload(): void {
    ...
    this._register(
      addDisposableListener(window, EventType.PAGE_SHOW, (e: PageTransitionEvent) =>
    ...
    this._onWillShutdown.fire({
      ...
      join(promise, id) {
        logService.error(
          `[lifecycle] Long running operations during shutdown are unsupported in the web (id: ${id})`,
        );
      },
      force: () => {
        /* No-Op in web */
