...
import { Emitter, Event, PauseableEmitter } from '@neditor/core/base/common/event';
import { Iterable } from '@neditor/core/base/common/iterator';
import { DisposableStore, IDisposable, MutableDisposable } from '@neditor/core/base/common/lifecycle';
import { TernarySearchTree } from '@neditor/core/base/common/map';
import { CommandsRegistry } from '@neditor/core/platform/commands/common/commands';
import {
  ConfigurationTarget,
  IConfigurationService,
} from '@neditor/core/platform/configuration/common/configuration';
import {
...
} from '@neditor/core/platform/contextkey/common/contextkey';
import { distinct } from '@neditor/core/base/common/objects';
...
export class NullContext extends Context {
...
export class ConfigAwareContextValuesContainer extends Context {
...
CommandsRegistry.registerCommand(
  SET_CONTEXT_COMMAND_ID,
  function (accessor, contextKey: any, contextValue: any) {
