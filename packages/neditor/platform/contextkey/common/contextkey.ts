...
import {
  ...
  isWeb,
  isWindows,
} from '@neditor/core/base/common/platform';
import { isFalsyOrWhitespace } from '@neditor/core/base/common/strings';
...
export abstract class ContextKeyExpr {
  ...
  private static _deserializeAndExpression(
    ...
    return ContextKeyAndExpr.create(
      pieces.map((p) => this._deserializeOne(p, strict)),
      null,
    );
  }
...
export class ContextKeyDefinedExpr implements IContextKeyExpression {
  ...
  protected constructor(readonly key: string, private negated: ContextKeyExpression | null) {}
...
export class ContextKeyNotExpr implements IContextKeyExpression {
  ...
  private constructor(private readonly key: string, private negated: ContextKeyExpression | null) {}
...
export interface IContextKeyServiceTarget {
  parentElement: IContextKeyServiceTarget | null | undefined;
...
export interface IContextKeyService {
  ...
  setContext<T>(key: string, val: T): void;
...
export function implies(p: ContextKeyExpression, q: ContextKeyExpression): boolean {
  if (
    q.type === ContextKeyExprType.And &&
    p.type !== ContextKeyExprType.Or &&
    p.type !== ContextKeyExprType.And
  ) {
