...
import { Promises, RunOnceScheduler, runWhenIdle } from '@neditor/core/base/common/async';
import { Emitter, Event, PauseableEmitter } from '@neditor/core/base/common/event';
import { Disposable, dispose, MutableDisposable } from '@neditor/core/base/common/lifecycle';
// import { mark } from '@neditor/core/base/common/performance';
import { isUndefinedOrNull } from '@neditor/core/base/common/type';
import {
...
export abstract class AbstractStorageService extends Disposable implements IStorageService {
  ...
  async logStorage(): Promise<void> {
    ...
    const workspaceItems =
      this.getStorage(StorageScope.WORKSPACE)?.items ?? new Map<string, string>();
