...
export class RoundedCorner {
  ...
  Inset(x: number, y: number): RoundedCorner {
...
export class RoundedCorners {
  ...
  constructor(top_left: RoundedCorner, top_right: RoundedCorner, bottom_right: RoundedCorner, bottom_left: RoundedCorner)
  constructor(a1?: unknown, a2?: unknown, a3?: unknown, a4?: unknown) {
  ...
  Inset(insets: InsetsF): RoundedCorners
  Inset(left: number, top: number, right: number, bottom: number): RoundedCorners
  Inset(a1: unknown, a2?: unknown, a3?: unknown, a4?: unknown): RoundedCorners {
    let top: number;
    let right: number;
    let bottom: number;
    let left: number;
  ...
  Scale(sx: number, sy: number): RoundedCorners {
    return new RoundedCorners(
...
// corresponding edge of the given rect.
  Normalize(rect: RectF): RoundedCorners {
    let scale = 1.0;
    let size;
  ...
  IsNormalized(rect: RectF): boolean {
