...
export interface ICopyableReference<T> extends IDisposable {
  readonly object: T;
  copy(): ICopyableReference<T>;
  count?(): number;
}
...
export abstract class ReferenceCollection<T> {
  ...
  acquire(key: string, ...args: any[]): ICopyableReference<T> {
