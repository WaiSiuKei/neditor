...
export class LineTool extends StrokeTool {
  get id(): string {
    return LineToolID;
  }
  //
...
export const LineToolID = 'tool.line';

export class LineToolFactory implements IToolFactory {
  id = LineToolID;

  createTool(canvas: ICanvas): ITool {
    return new LineTool(canvas, CursorStyle.arrow);
  }
