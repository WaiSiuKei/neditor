...
import { Slice, Fragment, ResolvedPos, Node } from '../model';
import { ReplaceStep, ReplaceAroundStep, Mappable } from '../transform';
...
export abstract class Selection {
  ...
  isNodeSelection(): this is NodeSelection {
    return false;
  }

  isTextSelection(): this is TextSelection {
    return false;
  }

  AsTextSelection(): Optional<TextSelection> {
    return undefined;
  }
}
...
export function selectionContextChanged(sel1: Selection, sel2: Selection) {
