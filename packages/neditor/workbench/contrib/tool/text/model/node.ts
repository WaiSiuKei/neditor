...
import { NodeType as CanvasNodeType } from '../../../../../common/node';
// import { isString } from "../../base/common/type";
// import { Optional } from "../../base/common/typescript";
// import { NOTIMPLEMENTED } from "../../base/common/notreached";
...
export class Node {
  ...
  static fromJSON(schema: Schema, json: any): Node {
    ...
    let marks: Optional<Mark[]>;
    // if (json.marks) {
    //   if (!Array.isArray(json.marks)) throw new RangeError("Invalid mark data for Node.fromJSON")
    //   marks = json.marks.map(schema.markFromJSON)
    // }
    if (json.type === 'inline-text') {
      if (!isString(json.content)) throw new RangeError('Invalid text node in JSON');
      return schema.text(json.content, marks);
    }
    ...
    return schema.nodeType('doc').create(json.attrs, content, marks);
  }
}
