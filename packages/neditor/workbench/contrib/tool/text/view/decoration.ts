import { Node, Mark } from "../model"
import { Mappable, Mapping } from "../transform"
...
export type WidgetConstructor = ((view: IEditorView, getPos: () => number | undefined) => DOMNode) | DOMNode
...
export function viewDecorations(view: IEditorView): DecorationSource {
