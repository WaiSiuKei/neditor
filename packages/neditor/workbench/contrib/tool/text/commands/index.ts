import { isMacintosh } from '../../../../../base/browser/platform';
import { KeyCode, KeyMod } from '../../../../../base/common/keyCodes';
import { Attrs, ContentMatch, Fragment, MarkType, NodeType, ResolvedPos, Slice } from '../model';
import { AllSelection, NodeSelection, SelectionRange, TextSelection } from '../state/selection';
import { EditorState } from '../state/state';
import { Command, Transaction } from '../state/transaction';
import { canJoin, canSplit, findWrapping, joinPoint, liftTarget, ReplaceAroundStep, ReplaceStep, replaceStep } from '../transform';
...
function atBlockStart(state: EditorState, view?: IEditorView): ResolvedPos | null {
...
function atBlockEnd(state: EditorState, view?: IEditorView): ResolvedPos | null {
  let { $cursor } = state.selection as TextSelection;
...
/// * **Mod-a** to `selectAll`
export const pcBaseKeymap: Map<number, Command> = new Map;
pcBaseKeymap.set(KeyCode.Enter, chainCommands(newlineInCode, createParagraphNear, liftEmptyBlock, splitBlock));
pcBaseKeymap.set(KeyCode.Enter | KeyMod.CtrlCmd, exitCode);
pcBaseKeymap.set(KeyCode.Backspace, backspace);
pcBaseKeymap.set(KeyCode.Backspace | KeyMod.Shift, backspace);
pcBaseKeymap.set(KeyCode.Backspace | KeyMod.CtrlCmd, backspace);
pcBaseKeymap.set(KeyCode.Delete, del);
pcBaseKeymap.set(KeyCode.Delete | KeyMod.Shift, del);
pcBaseKeymap.set(KeyCode.KEY_A | KeyMod.CtrlCmd, selectAll);

/// A copy of `pcBaseKeymap` that also binds **Ctrl-h** like Backspace,
/// **Ctrl-d** like Delete, **Alt-Backspace** like Ctrl-Backspace, and
/// **Ctrl-Alt-Backspace**, **Alt-Delete**, and **Alt-d** like
/// Ctrl-Delete.
export const macBaseKeymap: { [key: number]: Command } = {
...
export const baseKeymap = pcBaseKeymap;
