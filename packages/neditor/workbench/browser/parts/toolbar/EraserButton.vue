<template>
  <IconButton :isActive="isActive" :onClick="onClick">
    <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <line x1="6.01807" y1="12.5" x2="10.7959" y2="12.5" stroke="currentColor" stroke-linecap="round"></line>
      <line x1="5.50834" y1="5.74606" x2="10.1984" y2="10.4361" stroke="currentColor"></line>
    </svg>
  </IconButton>
</template>
